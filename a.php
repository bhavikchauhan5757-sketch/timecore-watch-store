            ...
            <div class="swiper-wrapper">
                ...
                <div class="hero-single-slider-item swiper-slide">
                    ...
                    <div class="hero-slider-bg">
                        <img src="assets/images/hero-slider/home-1/watch3.jpg" alt="">
                    </div>
                    <!-- Hero Slider Content -->
                            ...
                            <div class="row">
                                <div class="col-auto">
                                    <div class="hero-slider-content">
                                        <h4 class="title"style="color: white;">Timecore</h4>
                                        <h2 class="subtitle" style="color: white;">Time is at the heart of everything</h2>
                                        <a href="product.php"
                ...
                <div class="hero-single-slider-item swiper-slide">
                    <!-- Hero Slider Image -->
                    <div class="hero-slider-bg">
                        <img src="assets/images/hero-slider/home-1/watch4.png" alt="">
                    </div>
                    <!-- Hero Slider Content -->
                    <div class="hero-slider-wrapper">
                        <div class="container">
                            <div class="row">
                                <div class="col-auto">
                                    <div class="hero-slider-content">
                                        <h4 class="title" style="color: white;">Timecore</h4>
                                        <h2 class="subtitle" style="color: white;">The Mark of a True Gentleman</h2>
                                        <a href="product.php"
                                            class="btn btn-lg btn-outline-golden" style="color: white; border-color: white;">shop now </a>
                                    </div>
                                </div>
